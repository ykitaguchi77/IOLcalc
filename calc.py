...
class ActivateChromeWindow(QWidget):
   def __init__(self):
      ...
      window_width = 400
      window_height = 700  # ウィンドウの高さを600に変更 
      ...
      self.result_label.setGeometry(50, 340, 300, 360)  # 位置を(50, 340)に調整し、高さを360に変更
      self.result_label.setStyleSheet("font-size: 12px;")  # フォントサイズを12ピクセルに設定
   ...
   def show_result(self):
      ...
      try:
          ...
          # 'shift_jis'でもデコードできない場合の代替エンコーディングを試す
